createChapterWheel = function (n, t, i, r) {
    var u = new wheelnav("chapterWheelDiv"), f;
    ...
    n === "" ? (u.navItems[0].navigateFunction = function () {
        window.location.href = t
    }, u.navItems[1].navigateFunction = function () {
        window.location.href = "../documentation.html"
    }) : t === "" ? (u.navItems[0].navigateFunction = function () {
        window.location.href = "../documentation.html"
    }, u.navItems[1].navigateFunction = function () {
...
createNavBar = function (n, t) {
    var u, i, r, f;
    $("head").append("<link href='https://fonts.googleapis.com/css?family=Anton' rel='stylesheet' type='text/css'>");
    u = "";
    u = n === "" ? "." : "..";
    i = "";
    i += "<div class='container'>";
    i += "   <div class='navbar navbar-inverse navbar-fixed-top' role='navigation' hidden>";
    i += "       <div class='container'>";
    ...
    i += "                   <span class='icon-bar'><\/span>";
    i += "               <\/button>";
    i += "               <div id='logoWheel' class='pull-left' style='width: 50px; height: 50px' hidden><\/div><a class='navbar-brand brand-link' href='" + u + "'><\/a>";
    i += "           <\/div>";
    i += "           <div class='navbar-collapse collapse'>";
    i += "               <ul class='nav navbar-nav'>";
    i += t === "index" ? "                   <li class='active'>" : "                   <li>";
    i += "<a href='" + u + "/'><\/a><\/li>";
    i += t === "examples" ? "                   <li class='active'>" : "                   <li>";
    i += "<a href='" + u + "'><\/a><\/li>";
    r = "";
    r = n === "" ? "documentation" : ".";
    i += n === "documentation" || t === "documentation" ? "<li class='dropdown active'>" : "<li class='dropdown'>";
    i += "  <a href='" + u + "/' class='dropdown-toggle' data-toggle='dropdown'><b class='caret'><\/b><\/a>";
    ...
    i += "  <\/ul>";
    i += "<\/li>";
    i += t === "spinit" ? "                   <li class='active'>" : "                   <li>";
    i += "<a href='" + u + "'><\/a><\/li>";
    i += t === "download" ? "                   <li class='active'>" : "                   <li>";
    i += "<a href='" + u + "'><\/a><\/li>";
    i += t === "inspirations" ? "                   <li class='active'>" : "                   <li>";
    i += "<a href='" + u + "'><\/a><\/li>";
    i += "               <\/ul>";
    i += "           <\/div>";
    i += "       <\/div>";
...
createFooter = function () {
    ...
    n += "<a href='https://github.com/softwaretailoring/wheelnav/stargazers' target='_blank' style='background-color: #e7e7e7;'>";
    ...
    n += "<\/div>";
    n += "<\/a>";
    n += "<a href='https://codepen.io/collection/DORero/' target='_blank' style='background-color: #e7e7e7;'>";
    n += "<div style='display: inline-block;' ";
    ...
    n += "<\/div>";
    n += "<\/a>";
    n += "<a href='https://twitter.com/intent/tweet?url=https://wheelnavjs.softwaretailoring.net/&hashtags=wheelnavjs&text=Animated circular navigation menus&via=sftwr_tlrng' target='_blank' style='background-color: #e7e7e7;'>";
    n += "<div style='display: inline-block;' ";
    ...
    n += "<\/div>";
    n += "<\/a>";
    n += "<a href='https://stackoverflow.com/questions/tagged/wheelnav.js' target='_blank' style='background-color: #e7e7e7;'>";
    n += "<div style='display: inline-block;' ";
    ...
    n += "<\/div>";
    n += "<\/a>";
    n += "<p class='pull-right copy'>&copy; 2014-2022 <a href='https://softwaretailoring.net' target='_blank'>softwaretailoring.net<\/a><\/p>";
    n += "<\/div>";
    document.getElementById("wheelNavFooter") !== null && (document.getElementById("wheelNavFooter").innerHTML = n);
