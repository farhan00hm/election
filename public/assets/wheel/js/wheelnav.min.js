...
wheelnav.prototype.createWheel = function (n, t) {
    ...
    if (this.keynavigateEnabled) {
        ...
        u.addEventListener("keydown", this.keyNavigateFunction = function (n) {
            ...
            t = null;
            (i === r.keynavigateUpCode || i === r.keynavigateUpCodeAlt) && (t = r.currentClick === r.navItemCount - 1 ? 0 : r.currentClick + 1);
            (i === r.keynavigateDownCode || i === r.keynavigateDownCodeAlt) && (t = r.currentClick === 0 ? r.navItemCount - 1 : r.currentClick - 1);
            t !== null && (r.navItems[t].navigateFunction !== null && r.navItems[t].navigateFunction(), r.navigateWheel(t))
        })
    }
...
wheelnav.prototype.animateUnlock = function (n, t) {
    var i, r;
    if (n !== undefined && n === !0) for (i = 0; i < this.navItemCount; i++) this.navItems[i].navSliceUnderAnimation = !1, this.navItems[i].navTitleUnderAnimation = !1, this.navItems[i].navLineUnderAnimation = !1, this.navItems[i].navSlice.stop(), this.navItems[i].navLine.stop(), this.navItems[i].navTitle.stop(); else {
        for (r = 0; r < this.navItemCount; r++) if (this.navItems[r].navSliceUnderAnimation === !0 || this.navItems[r].navTitleUnderAnimation === !0 || this.navItems[r].navLineUnderAnimation === !0) return;
...
wheelnav.prototype.setTooltips = function (n) {
    if (n !== undefined && n !== null && Array.isArray(n) && n.length <= this.navItems.length) for (var t = 0; t < n.length; t++) this.navItems[t].setTooltip(n[t])
};
...
wheelnav.prototype.parseWheel = function (n) {
    ...
    if (n !== undefined && n !== null) {
        if (it = n.hasAttribute("data-wheelnav"), it) {
            var i = [], h = [], f = [], rt = !1, c = n.getAttribute("data-wheelnav-slicepath");
            for (c !== null && slicePath()[c] !== undefined && (this.slicePathFunction = slicePath()[c]), l = n.getAttribute("data-wheelnav-colors"), l !== null && (this.colors = l.split(",")), a = n.getAttribute("data-wheelnav-wheelradius"), a !== null && (this.wheelRadius = Number(a)), v = n.getAttribute("data-wheelnav-navangle"), v !== null && (this.navAngle = Number(v)), ut = n.getAttribute("data-wheelnav-rotateoff"), ut !== null && (this.clickModeRotate = !1), ft = n.getAttribute("data-wheelnav-cssmode"), ft !== null && (this.cssMode = !0), et = n.getAttribute("data-wheelnav-spreader"), et !== null && (this.spreaderEnable = !0), y = n.getAttribute("data-wheelnav-spreaderradius"), y !== null && (this.spreaderRadius = Number(y)), e = n.getAttribute("data-wheelnav-spreaderpath"), e !== null && markerPath()[e] !== undefined && (this.spreaderPathFunction = spreaderPath()[e]), ot = n.getAttribute("data-wheelnav-marker"), ot !== null && (this.markerEnable = !0), o = n.getAttribute("data-wheelnav-markerpath"), o !== null && markerPath()[o] !== undefined && (this.markerPathFunction = markerPath()[o]), p = n.getAttribute("data-wheelnav-titlewidth"), p !== null && (this.titleWidth = Number(p)), w = n.getAttribute("data-wheelnav-titleheight"), w !== null && (this.titleHeight = Number(w)), st = n.getAttribute("data-wheelnav-keynav"), st !== null && (this.keynavigateEnabled = !0), ht = n.getAttribute("data-wheelnav-keynavonlyfocus"), ht !== null && (this.keynavigateOnlyFocus = !0), b = n.getAttribute("data-wheelnav-keynavdowncode"), b !== null && (this.keynavigateDownCode = Number(b)), k = n.getAttribute("data-wheelnav-keynavdowncodealt"), k !== null && (this.keynavigateDownCodeAlt = Number(k)), d = n.getAttribute("data-wheelnav-keynavupcode"), d !== null && (this.keynavigateUpCode = Number(d)), g = n.getAttribute("data-wheelnav-keynavupcodealt"), g !== null && (this.keynavigateUpCodeAlt = Number(g)), ct = n.getAttribute("data-wheelnav-init"), ct !== null && (rt = !0), t = 0; t < n.children.length; t++) {
                ...
                if (nt !== null || r !== null || tt !== null) {
                    if (nt !== null) i.push(nt); else if (r !== null) icon[r] !== undefined ? i.push(icon[r]) : i.push(r); else if (tt !== null) i.push("imgsrc:" + tt); else continue;
...
wheelnavItem.prototype.setCurrentTransform = function (n, t) {
    ...
    if (!this.wheelnav.clickModeRotate || !this.navSliceUnderAnimation && !this.navTitleUnderAnimation && !this.navLineUnderAnimation) if (n !== undefined && n === !0 && (this.navSliceUnderAnimation = !0, this.navTitleUnderAnimation = !0, this.navLineUnderAnimation = !0), this.navSliceCurrentTransformString = "", this.wheelnav.clickModeRotate && (this.navSliceCurrentTransformString += this.getItemRotateString()), this.selected ? this.selectTransform.sliceTransformString !== undefined && (this.navSliceCurrentTransformString += this.selectTransform.sliceTransformString) : this.hovered && this.hoverTransform.sliceTransformString !== undefined && (this.navSliceCurrentTransformString += this.hoverTransform.sliceTransformString), this.sliceTransform.sliceTransformString !== undefined && (this.navSliceCurrentTransformString += this.sliceTransform.sliceTransformString), this.navLineCurrentTransformString = "", this.wheelnav.clickModeRotate && (this.navLineCurrentTransformString += this.getItemRotateString()), this.selected ? this.selectTransform.lineTransformString !== undefined && (this.navLineCurrentTransformString += this.selectTransform.lineTransformString) : this.hovered && this.hoverTransform.lineTransformString !== undefined && (this.navLineCurrentTransformString += this.hoverTransform.lineTransformString), this.sliceTransform.lineTransformString !== undefined && (this.navLineCurrentTransformString += this.sliceTransform.lineTransformString), this.navTitleCurrentTransformString = "", this.navTitleCurrentTransformString += this.getTitleRotateString(!0), this.selected ? (this.navTitleSizeSelectedTransform !== undefined && (this.navTitleCurrentTransformString += this.navTitleSizeSelectedTransform), this.navTitleCurrentTransformString += this.selectTransform.titleTransformString === "" || this.selectTransform.titleTransformString === undefined ? ",s1" : "," + this.selectTransform.titleTransformString, this.wheelnav.currentPercent < .05 && (this.navTitleCurrentTransformString += ",s0.05")) : this.hovered ? (this.navTitleSizeHoverTransform !== undefined && (this.navTitleCurrentTransformString += this.navTitleSizeHoverTransform), this.navTitleCurrentTransformString += this.hoverTransform.titleTransformString === "" || this.hoverTransform.titleTransformString === undefined ? ",s1" : "," + this.hoverTransform.titleTransformString) : this.wheelnav.currentPercent < .05 ? this.navTitleCurrentTransformString += ",s0.05" : this.titleSpreadScale ? this.navTitleCurrentTransformString += ",s" + this.wheelnav.currentPercent : (this.navTitleSizeTransform !== undefined && (this.navTitleCurrentTransformString += this.navTitleSizeTransform), this.navTitleCurrentTransformString += this.sliceTransform.titleTransformString === "" || this.sliceTransform.titleTransformString === undefined ? ",s1" : "," + this.sliceTransform.titleTransformString), h = this.getCurrentPath(), c = {}, c = {
        ...
        height: r.height,
        transform: this.navTitleCurrentTransformString
    }, this.navTitle.attr({src: r.src})) : (f = {
        x: r.x,
        y: r.y,
        transform: this.navTitleCurrentTransformString
    }, r.title !== null && this.navTitle.attr({text: r.title})), e = this, o = this.wheelnav, this.animSlice = Raphael.animation(c, this.animatetime, this.animateeffect, function () {
        ...
        if (this.wheelItemIndex === this.wheelnav.navItemCount - 1) {
            ...
            if (this.wheelnav.sliceClickablePathFunction !== null) for (i = 0; i < this.wheelnav.navItemCount; i++) s = this.wheelnav.navItems[i], s.navClickableSlice !== null && s.navClickableSlice.animate(s.animClickableSlice.repeat(u))
        }
...
wheelnav.prototype.styleWheel = function () {
    this.cssMode ? (this.spreaderPathInAttr = {"class": this.getSpreaderCssClass("in")}, this.spreaderPathOutAttr = {"class": this.getSpreaderCssClass("out")}, this.spreaderTitleInAttr = {"class": this.getSpreaderTitleCssClass("in")}, this.spreaderTitleOutAttr = {"class": this.getSpreaderTitleCssClass("out")}, this.markerAttr = {"class": this.getMarkerCssClass()}) : ((this.spreaderPathInAttr === undefined || this.spreaderPathInAttr === null) && (this.spreaderPathInAttr = {
        fill: "#444",
        stroke: "#444",
        "stroke-width": 2,
        cursor: "pointer"
...
wheelnavItem.prototype.styleNavItem = function () {
    this.wheelnav.cssMode ? (this.slicePathAttr = {"class": this.wheelnav.getSliceCssClass(this.wheelItemIndex, "basic")}, this.sliceHoverAttr = {"class": this.wheelnav.getSliceCssClass(this.wheelItemIndex, "hover")}, this.sliceSelectedAttr = {"class": this.wheelnav.getSliceCssClass(this.wheelItemIndex, "selected")}, this.titleAttr = {"class": this.wheelnav.getTitleCssClass(this.wheelItemIndex, "basic")}, this.titleHoverAttr = {"class": this.wheelnav.getTitleCssClass(this.wheelItemIndex, "hover")}, this.titleSelectedAttr = {"class": this.wheelnav.getTitleCssClass(this.wheelItemIndex, "selected")}, this.linePathAttr = {"class": this.wheelnav.getLineCssClass(this.wheelItemIndex, "basic")}, this.lineHoverAttr = {"class": this.wheelnav.getLineCssClass(this.wheelItemIndex, "hover")}, this.lineSelectedAttr = {"class": this.wheelnav.getLineCssClass(this.wheelItemIndex, "selected")}) : (this.slicePathAttr = {
        ...
        fill: "#fff",
        cursor: "default"
    }, this.linePathAttr = {stroke: "#444", "stroke-width": 1, cursor: "pointer"}, this.lineHoverAttr = {
        stroke: "#222",
        "stroke-width": 2,
        cursor: "pointer"
...
slicePath = function () {
    return this.NullSlice = function (n, t, i) {
        ...
        n.setBaseValue(t, i);
        var r = n.sliceRadius * i.arcBaseRadiusPercent, u = n.sliceRadius * i.arcRadiusPercent;
        ...
        endTheta = n.endTheta;
        var u;
        return n.sliceAngle < 120 ? (n.titleRadius = r * .57, u = .9) : n.sliceAngle < 180 ? (n.titleRadius = r * .52, u = .91) : (n.titleRadius = r * .45, u = .873), slicePathString = [n.MoveTo(n.middleAngle, r * .07), ["L", r * .07 * Math.cos(middleTheta) + r * .87 * Math.cos(startTheta) + x, r * .07 * Math.sin(middleTheta) + r * .87 * Math.sin(startTheta) + y], ["A", r * u, r * u, 0, 0, 1, r * .07 * Math.cos(middleTheta) + r * .87 * Math.cos(endTheta) + x, r * .07 * Math.sin(middleTheta) + r * .87 * Math.sin(endTheta) + y], n.Close()], linePathString = [n.MoveTo(n.startAngle, r), n.ArcTo(r, n.endAngle, r), n.ArcBackTo(r, n.startAngle, r)], n.setTitlePos(), {
            slicePathString: slicePathString,
            linePathString: linePathString,
            titlePosX: n.titlePosX,
            titlePosY: n.titlePosY
...
spreader = function (n) {
    ...
    if (this.wheelnav = n, this.wheelnav.spreaderEnable) {
        ...
        this.fontAttr = this.wheelnav.spreaderTitleFont !== null ? {font: this.wheelnav.spreaderTitleFont} : {font: "100 32px Impact, Charcoal, sans-serif"};
...
spreader.prototype.setCurrentTransform = function (n) {
    if (this.wheelnav.spreaderEnable) {
        if (n === undefined || n === !1) {
            ...
            wheelnavTitle().isPathTitle(t.title) ? (i.path = t.path, i.transform = r) : wheelnavTitle().isImageTitle(t.title) ? (i.x = t.x, i.y = t.y, i.width = t.width, i.height = t.height, this.spreaderTitle.attr({src: t.src})) : (offYOffset = 0, t.title === "-" && (offYOffset = 3), i.x = t.x, i.y = t.y - offYOffset, t.title !== null && this.spreaderTitle.attr({text: t.title}));
...
marker.prototype.setCurrentTransform = function (n) {
    ...
    this.wheelnav.markerEnable && (t = "", t = this.wheelnav.currentPercent === this.wheelnav.maxPercent ? this.markerPathMax.markerPathString : this.markerPathMin.markerPathString, n !== undefined ? (i = n - this.markerHelper.navAngle, markerTransformAttr = {
        ...
        path: t
    }) : markerTransformAttr = {path: t}, this.marker.animate(markerTransformAttr, this.animatetime, this.animateeffect), this.marker.toFront())
};
markerPath = function () {
    return this.NullMarker = function (n, t) {
        ...
        var u = n.sliceRadius * i.arcBaseRadiusPercent, r = n.sliceRadius * i.arcRadiusPercent,
            f = n.startAngle + n.sliceAngle * .46, e = n.startAngle + n.sliceAngle * .54;
        ...
        n.setBaseValue(i.markerPercent * t, i);
        var u = n.sliceRadius * i.dropBaseRadiusPercent, f = n.startAngle + n.sliceAngle * .2, e = n.startAngle,
